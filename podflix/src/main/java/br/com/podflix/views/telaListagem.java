...
public class telaListagem extends javax.swing.JFrame {
    ...
    public telaListagem() {
        initComponents();
        PodcastsDAO podDao = new PodcastsDAO();
        List<Podcasts> receitas = podDao.listar("");
    ...
    private void initComponents() {
        ...
        tblPodcast.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Produtor", "Nome Episódio", "Num Episódio", "Duração", "URL Repositório"
            }
        ));
        ...
        jLabel4.setText("Pesquisar podcast por produtor: ");
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addComponent(idfield, javax.swing.GroupLayout.PREFERRED_SIZE, 269, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         PodcastsDAO podDao = new PodcastsDAO();
        List<Podcasts> receitas = podDao.listar(idfield.getText());
        preencheTabela(receitas);
    ...
    public void preencheTabela(List<Podcasts> receitas){
    String colunas[] = {"Id", "Produtor", "Nome Episodio", "Num Episódio", "Duração", "URL Repositório"};
    String dados[][] = new String[receitas.size()][colunas.length];

    int i=0;
    for(Podcasts r: receitas){
        dados[i] = new String[]{ 
            String.valueOf(r.getId()), 
            r.getProdutor(), 
            r.getNomeEp(), 
            String.valueOf(r.getNumEp()), 
